...
<div class="card shadow-sm">
    <div class="card-header bg-white d-flex justify-content-between align-items-center">
        ...
        <a href="<?php echo URLROOT; ?>/clients" class="btn btn-outline-secondary btn-sm"><i class="fa fa-arrow-left me-1"></i> Volver</a>
    </div>
    <div class="card-body">
        <form action="<?php echo URLROOT; ?>/clients/edit/<?php echo h($data['id']); ?>" method="post">
            <?= csrfField() ?>
            <div class="mb-3">
