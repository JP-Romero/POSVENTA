    ...
    <div class="col-md-8 mx-auto">
        <div class="card shadow-sm">
            <div class="card-header bg-white d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo URLROOT; ?>/users" class="btn btn-outline-secondary btn-sm"><i class="fa fa-arrow-left me-1"></i> Volver</a>
            </div>
            <div class="card-body">
                <form action="<?php echo URLROOT; ?>/users/add" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nombre" class="form-control" required aria-label="Nombre del usuario">
                    </div>
                    <div class="mb-3">
                        <label for="usuario" class="form-label">Usuario:</label>
                        <input type="text" name="usuario" class="form-control" required aria-label="Nombre de usuario">
                    </div>
                    <div class="mb-3">
                        <label for="password" class="form-label">Contraseña:</label>
                        <input type="password" name="password" class="form-control" required aria-label="Contraseña">
                    </div>
                    <div class="mb-3">
